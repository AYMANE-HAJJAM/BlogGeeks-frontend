...
const Dashboard = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://bloggeeks-backend-production.up.railway.app/blog/create",
        formData,
        {
          headers: {
  ...
  useEffect(() => {
    const allBlogs = async () => {
      try {
        const res = await axios.get("https://bloggeeks-backend-production.up.railway.app/blog/all", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const removeBlog = async (blogId) => {
    try {
      const res = await axios.delete(
        `https://bloggeeks-backend-production.up.railway.app/blog/delete/${blogId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
